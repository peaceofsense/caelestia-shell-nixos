...
> [!TIP]
> **NixOS Users**: See [README-nixos.md](README-nixos.md) for NixOS-specific installation instructions
> that use quickshell's native IPC system instead of caelestia-cli.
